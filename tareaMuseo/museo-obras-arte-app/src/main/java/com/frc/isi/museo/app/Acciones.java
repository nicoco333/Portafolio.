...
import com.frc.isi.museo.app.menu.ApplicationContext; 
import com.frc.isi.museo.app.servicios.EstiloArtisticoService;
import com.frc.isi.museo.app.servicios.ObraArtisticaService;

public class Acciones {

    public void informeObrasExhibidas(ApplicationContext context) {
        var lector = (Scanner) context.get("lector", null);
    ...
    public void informeObrasMayorPromedio(ApplicationContext context) {
        var servicio = context.getService(ObraArtisticaService.class);
    ...
    public void generarTextoCantidadPorEstilo(ApplicationContext context) {
        ...
        try {
            var pathToExport = (URL) context.get("path", null);
    ...
    public void importarObras(ApplicationContext context) {
        var pathToImport = (URL) context.get("path", null);
