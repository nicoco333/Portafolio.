...
import com.frc.isi.museo.app.menu.ItemMenu;
import com.frc.isi.museo.app.menu.Menu;
...
public class App {
    public static void main(String[] args) {
        ...
        ctx.registerService(ObraArtisticaService.class, new ObraArtisticaService());
